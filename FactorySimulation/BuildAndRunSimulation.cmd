...
docker run -itd -p 8081:80 -v "c:/docker/Shared/CertificateStores/UA Applications/certs":/app/pki/trusted/certs -v c:/docker/Logs/publisher.capetown.corp.contoso:/app/logs -v c:/docker/Config/publisher.capetown.corp.contoso:/app/settings --name publisher.capetown.corp.contoso -h publisher.capetown.corp.contoso --network capetown.corp.contoso --restart always ghcr.io/barnstee/ua-cloudpublisher:main
docker run -itd -p 8082:80 -v "c:/docker/Shared/CertificateStores/UA Applications/certs":/app/pki/trusted/certs -v c:/docker/Logs/publisher.mumbai.corp.contoso:/app/logs -v c:/docker/Config/publisher.mumbai.corp.contoso:/app/settings --name publisher.mumbai.corp.contoso -h publisher.mumbai.corp.contoso --network mumbai.corp.contoso --restart always ghcr.io/barnstee/ua-cloudpublisher:main
docker run -itd -p 8083:80 -v "c:/docker/Shared/CertificateStores/UA Applications/certs":/app/pki/trusted/certs -v c:/docker/Logs/publisher.seattle.corp.contoso:/app/logs -v c:/docker/Config/publisher.seattle.corp.contoso:/app/settings --name publisher.seattle.corp.contoso -h publisher.seattle.corp.contoso --network seattle.corp.contoso --restart always ghcr.io/barnstee/ua-cloudpublisher:main
docker run -itd -p 8084:80 -v "c:/docker/Shared/CertificateStores/UA Applications/certs":/app/pki/trusted/certs -v c:/docker/Logs/publisher.beijing.corp.contoso:/app/logs -v c:/docker/Config/publisher.beijing.corp.contoso:/app/settings --name publisher.beijing.corp.contoso -h publisher.beijing.corp.contoso --network beijing.corp.contoso --restart always ghcr.io/barnstee/ua-cloudpublisher:main
docker run -itd -p 8085:80 -v "c:/docker/Shared/CertificateStores/UA Applications/certs":/app/pki/trusted/certs -v c:/docker/Logs/publisher.rio.corp.contoso:/app/logs -v c:/docker/Config/publisher.rio.corp.contoso:/app/settings --name publisher.rio.corp.contoso -h publisher.rio.corp.contoso --network rio.corp.contoso --restart always ghcr.io/barnstee/ua-cloudpublisher:main
