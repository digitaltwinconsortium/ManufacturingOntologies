...
- [Add agentic AI to the reference solution](agenticai.md) describes how to put an AI agent on top of the reference solution, starting with a read-only Plant Copilot MCP server that answers natural-language questions grounded in the plant's live and historical data.
