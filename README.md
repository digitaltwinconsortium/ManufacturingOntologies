...
5. Under Access Control -> Role Assignments of your Azure Digital Twin service instance, add a new Role Assignment of type "Azire Digital Twins Data Owner", assign it's access to "Managed Identity" and under "Select Users", select your previously deployed Azure Web App service instance.
