...
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.munich.corp.contoso -h twin.munich.corp.contoso --network munich.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.capetown.corp.contoso -h twin.capetown.corp.contoso --network capetown.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.mumbai.corp.contoso -h twin.mumbai.corp.contoso --network mumbai.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.seattle.corp.contoso -h twin.seattle.corp.contoso --network seattle.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.beijing.corp.contoso -h twin.beijing.corp.contoso --network beijing.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
docker run -itd -v c:/docker/Shared:/Shared -e AutoAcceptUntrustedCertificates="TRUE" -e EdgeHubConnectionString="ENTER_TWIN_DEVICE_CONNECTION_STRING_HERE" -e TrustedPeerCertificatesPath="/Shared/CertificateStores/UA Applications" --name twin.rio.corp.contoso -h twin.rio.corp.contoso --network rio.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-twin:latest --host
