...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.beijing.corp.contoso:/Logs -w /app --name MES.beijing1.corp.contoso -h MES.beijing1.corp.contoso --network beijing.corp.contoso --restart always simulation:latest /app/MES.dll beijing1
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.beijing.corp.contoso:/Logs -w /app --name MES.beijing2.corp.contoso -h MES2.beijing.corp.contoso --network beijing.corp.contoso --restart always simulation:latest /app/MES.dll beijing2
...
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/publisher.munich.corp.contoso:/Logs -v c:/docker/Config/publisher.munich.corp.contoso:/Config --name publisher.munich.corp.contoso -h publisher.munich.corp.contoso --network munich.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-publisher:latest publisher.munich.corp.contoso --dc ENTER_PUBLISHER_DEVICE_CONNECTION_STRING_HERE --pf /Config/publishednodes.JSON --tp "/Shared/CertificateStores/UA Applications" --lf /Logs/publisher.munich.corp.contoso.log.txt --si 1 --ms 0 --di 60 --oi 1000 --op 1000 --fd true --tm true
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/publisher.capetown.corp.contoso:/Logs -v c:/docker/Config/publisher.capetown.corp.contoso:/Config --name publisher.capetown.corp.contoso -h publisher.capetown.corp.contoso --network capetown.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-publisher:latest publisher.capetown.corp.contoso --dc ENTER_PUBLISHER_DEVICE_CONNECTION_STRING_HERE --pf /Config/publishednodes.JSON --tp "/Shared/CertificateStores/UA Applications" --lf /Logs/publisher.capetown.corp.contoso.log.txt --si 1 --ms 0 --di 60 --oi 1000 --op 1000 --fd true --tm true
...
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/publisher.seattle.corp.contoso:/Logs -v c:/docker/Config/publisher.seattle.corp.contoso:/Config --name publisher.seattle.corp.contoso -h publisher.seattle.corp.contoso --network seattle.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-publisher:latest publisher.seattle.corp.contoso --dc ENTER_PUBLISHER_DEVICE_CONNECTION_STRING_HERE --pf /Config/publishednodes.JSON --tp "/Shared/CertificateStores/UA Applications" --lf /Logs/publisher.seattle.corp.contoso.log.txt --si 1 --ms 0 --di 60 --oi 1000 --op 1000 --fd true --tm true
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/publisher.beijing.corp.contoso:/Logs -v c:/docker/Config/publisher.beijing.corp.contoso:/Config --name publisher.beijing.corp.contoso -h publisher.beijing.corp.contoso --network beijing.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-publisher:latest publisher.beijing.corp.contoso --dc ENTER_PUBLISHER_DEVICE_CONNECTION_STRING_HERE --pf /Config/publishednodes.JSON --tp "/Shared/CertificateStores/UA Applications" --lf /Logs/publisher.beijing.corp.contoso.log.txt --si 1 --ms 0 --di 60 --oi 1000 --op 1000 --fd true --tm true
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/publisher.rio.corp.contoso:/Logs -v c:/docker/Config/publisher.rio.corp.contoso:/Config --name publisher.rio.corp.contoso -h publisher.rio.corp.contoso --network rio.corp.contoso --restart always mcr.microsoft.com/iotedge/opc-publisher:latest publisher.rio.corp.contoso --dc ENTER_PUBLISHER_DEVICE_CONNECTION_STRING_HERE --pf /Config/publishednodes.JSON --tp "/Shared/CertificateStores/UA Applications" --lf /Logs/publisher.rio.corp.contoso.log.txt --si 1 --ms 0 --di 60 --oi 1000 --op 1000 --fd true --tm true
