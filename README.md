...
| [Azure Logic Apps Data Gateway](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-gateway-install#how-the-gateway-works) | The gateway connects your on-premises data sources to Azure Logic Apps in the cloud. |
