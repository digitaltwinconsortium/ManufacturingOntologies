...
If you want to view the digital twins graph automatically created in the Azure Digital Twins service, assign yourself Azure Digital Twins Data Owner permission in the Azure Portal and open the ADT Explorer directly from the Azure Digital Twins overview page.
