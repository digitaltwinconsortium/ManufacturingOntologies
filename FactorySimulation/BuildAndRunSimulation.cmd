...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.munich.corp.contoso:/Logs -v c:/docker/Config/MES.munich.corp.contoso:/Config -w /app --name MES.munich.corp.contoso -h MES.munich.corp.contoso --network munich.corp.contoso --restart always simulation:latest /app/MES.dll munich
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.capetown.corp.contoso:/Logs -v c:/docker/Config/MES.capetown.corp.contoso:/Config -w /app --name MES.capetown.corp.contoso -h MES.capetown.corp.contoso --network capetown.corp.contoso --restart always simulation:latest /app/MES.dll capetown
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.mumbai.corp.contoso:/Logs -v c:/docker/Config/MES.mumbai.corp.contoso:/Config -w /app --name MES.mumbai.corp.contoso -h MES.mumbai.corp.contoso --network mumbai.corp.contoso --restart always simulation:latest /app/MES.dll mumbai
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.seattle.corp.contoso:/Logs -v c:/docker/Config/MES.seattle.corp.contoso:/Config -w /app --name MES.seattle.corp.contoso -h MES.seattle.corp.contoso --network seattle.corp.contoso --restart always simulation:latest /app/MES.dll seattle
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.beijing.corp.contoso:/Logs -v c:/docker/Config/MES.beijing1.corp.contoso:/Config -w /app --name MES.beijing1.corp.contoso -h MES.beijing1.corp.contoso --network beijing.corp.contoso --restart always simulation:latest /app/MES.dll beijing1
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.beijing.corp.contoso:/Logs -v c:/docker/Config/MES.beijing2.corp.contoso:/Config -w /app --name MES.beijing2.corp.contoso -h MES2.beijing.corp.contoso --network beijing.corp.contoso --restart always simulation:latest /app/MES.dll beijing2
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.beijing3.corp.contoso:/Logs -v c:/docker/Config/MES.beijing3.corp.contoso:/Config -w /app --name MES.beijing3.corp.contoso -h MES.beijing3.corp.contoso --network beijing.corp.contoso --restart always simulation:latest /app/MES.dll bejing3
...
Timeout 5
docker run -itd -v c:/docker/Shared:/Shared -v c:/docker/Logs/MES.rio.corp.contoso:/Logs -v c:/docker/Config/MES.rio.corp.contoso:/Config -w /app --name MES.rio.corp.contoso -h MES.rio.corp.contoso --network rio.corp.contoso --restart always simulation:latest /app/MES.dll rio
